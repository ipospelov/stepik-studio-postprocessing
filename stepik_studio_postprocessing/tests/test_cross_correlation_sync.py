...
class TestCCSync(unittest.TestCase):
    ...
    def test_should_get_right_difference_invert(self):
        fd_delayed = AudioFileDescriptor('data/test_non_delayed.wav')
        fd_original= AudioFileDescriptor('data/test_delayed.wav')
